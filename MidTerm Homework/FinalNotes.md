...
All of this project 6-12, I asked AI for 90% to help me write is the homework for all of this project. Here is all of references: (Very sorry if this references might not full explain this project, since some of code already disappear/combined with other chat/not saved).
References
